...
textnumbruhcredit = tk.Label( root, text='and with help from KamiQu', bg='black', fg='white', font='none 25')

textnumICANNT = tk.Label( root, text='V1.0p (public)', bg='black', fg='white', font='none 25')
...
if finalmol == None:
    ...
    root.withdraw()
    root.iconbitmap(resource_path("PS4poopybench.ico"))
    imacheckthiskk = tk.messagebox.showinfo(title='eZobj2mol', message='Done, enjoy!')
