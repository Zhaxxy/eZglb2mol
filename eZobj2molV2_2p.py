...
textnumICANNT = tk.Label( root, text='V2.2p (public)', bg='black', fg='white', font='none 25')
...
try:
    ...
    hash1 = open("eZDONT_DELETE_OR_OVERWRITEworking.molt", "r+")
    hash1.seek(882501 * 2)
    hash1.write(gmathash)
    hash1.close()
    hash2 = open("eZDONT_DELETE_OR_OVERWRITEworking.molt", "r+")
    hash2.seek(882601 * 2)
    hash2.write(gmathash)
    hash2.close()
    hash3 = open("eZDONT_DELETE_OR_OVERWRITEworking.molt", "r+")
    hash3.seek(882551 * 2)
    hash3.write(gmathash)
    hash3.close()
